...
keywords = [
    ...
    # "영등포구 당산동 놀거리", "영등포구 문래동 놀거리", "영등포구 대림동 놀거리", "영등포구 신길동 놀거리", "영등포구 양평동 놀거리",
    ...
    # "종로구 혜화동 놀거리", "중구 남대문로 놀거리", "중구 명동 놀거리", "중구 을지로동 놀거리",
    "중구 예관동 놀거리"
...
# 하루필름, 포토그레이, 포토이즘, 비룸 스튜디오, 셀픽스, 나랑한컷, 포토매틱, 그믐달
            ...
            for i, listitem in enumerate(final_list_items):
                try:
                    ...
                    try:
                        ...
                        #------------------------------------------------------#
                        # 영업시간은 따로 restaurant에 저장 x, api로 호출해서 가져오기
                        #------------------------------------------------------#
